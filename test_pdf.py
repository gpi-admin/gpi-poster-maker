"""
テスト: ReportLab ベクターPDF 出力
test_preview.py と同じデータでPDFを生成し、Illustratorで確認できる。
実行: python test_pdf.py
"""
...
print("ベクターPDFを生成中...")
pdf_bytes = render_poster_pdf(data)
...
print("   Illustrator で開いて要素が個別選択できることを確認してください。")
