...
# ポスター中央（50%）より少し左 38.5〜50% に配置
TITLE_X = 0.385   # メインタイトル帯左端 X（= 左カラム右端）
TITLE_W = 0.115   # メインタイトル帯幅

# 右ストリップ（「2025年度」+ 第N部ラベルボックス）
SECT_X  = TITLE_X + TITLE_W   # = 0.500（ポスター中央）
SECT_W  = 0.040              # ≈ 4%（細いストリップ）

# プログラムエリア（ポスター右側 54〜100%）
PROG_X  = SECT_X + SECT_W    # = 0.540
